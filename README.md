...
4. **مراجع مستقل:** ابنِ الحزمة بـ`python tools/build_review_pack.py --out evaluations/review-pack` وسلّمها لمراجع من خارج المشروع ليكمل نموذجها (صفّا 10 و11، و`independent_proof`).
