...
`eaos` حزمة Python من **10,921 سطرًا** في **86 ملفًا**، تُثبَّت كـ wheel وتُشغَّل من سطر الأوامر على مستودع هدف **للقراءة فقط**. وظيفتها ليست «العثور على مشاكل» بل **إنتاج سجل ادعاءات قابل للتفنيد** حول مستودع، ثم اشتقاق قرارات وخطة منه.
