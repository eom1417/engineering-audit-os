...
STAGES = (
    ...
    Stage('claims', produces=('dossier.json', 'DECISION-BRIEF.md'), requires=('facts',),
    ...
    Stage('sustainability', produces=('SUSTAINABILITY.md',), requires=('claims',),
    ...
    Stage('compose', produces=('README.md', 'PRODUCT-REPORT.md'), requires=('plan',),
