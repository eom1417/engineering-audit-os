# TASK-002 — 236 functions perform the same ordered sequence of calls (internal/config/output_dir_test.go:None, internal/diff/attribu

> claim: CLM-004 · pattern: canonicalize · priority: 0.0961
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-004: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the shared order is coincidental rather than one orchestration copied. |
