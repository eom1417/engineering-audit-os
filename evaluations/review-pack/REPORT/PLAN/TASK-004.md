# TASK-004 — packaging/pypi/build_wheel.py: ينادي خدمة خارجية بلا مهلة أو إعادة محاولة — load blocker (unprotected_dependency)

> claim: CLM-002 · pattern: load_blocker · priority: 0.0784
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-002: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. A timeout, retry policy or circuit breaker on the call, or evidence the call is local. |
