# TASK-045 — 59 symbols share the same structure up to identifier names (internal/explainers/complexity/complexity.go:33 .function_de

> claim: CLM-501 · pattern: canonicalize · priority: 0.0272
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-501: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing. |
