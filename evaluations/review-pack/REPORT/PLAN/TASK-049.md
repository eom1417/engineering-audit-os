# TASK-049 — 2 symbols share the same structure up to identifier names (internal/extractors/grpcextractor/grpc.go:37 .method_declarat

> claim: CLM-146 · pattern: canonicalize · priority: 0.0259
...
2 symbols share the same structure up to identifier names (internal/extractors/grpcextractor/grpc.go:37 .method_declarat

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-59416873a18146af
- probes: PRB-049
- falsifier: Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing.

## Blast radius

- files: internal/extractors/grpcextractor/grpc.go, internal/extractors/mdintent/mdintent.go
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-146: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing. |
