# TASK-050 — 2 symbols share the same structure up to identifier names (internal/extractors/javaextractor/httpclient.go:221 .function

> claim: CLM-154 · pattern: canonicalize · priority: 0.0259
...
2 symbols share the same structure up to identifier names (internal/extractors/javaextractor/httpclient.go:221 .function

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-a85fad7d5ad79387
- probes: PRB-050
- falsifier: Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing.

## Blast radius

- files: internal/extractors/javaextractor/httpclient.go, internal/extractors/kotlinextractor/retrofit.go
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-154: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing. |
