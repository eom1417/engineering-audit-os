# TASK-064 — 3 symbols share the same structure up to identifier names (pkg/bootstrap/bootstrap.go:173 .method_declaration, pkg/boots

> claim: CLM-455 · pattern: canonicalize · priority: 0.0219
...
3 symbols share the same structure up to identifier names (pkg/bootstrap/bootstrap.go:173 .method_declaration, pkg/boots

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-41ac39883040045a
- probes: PRB-064
