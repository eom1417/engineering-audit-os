# TASK-088 — 2 symbols share the same structure up to identifier names (internal/explainers/crossrepo/crossrepo.go:174 .function_decl

> claim: CLM-074 · pattern: canonicalize · priority: 0.0172
...
2 symbols share the same structure up to identifier names (internal/explainers/crossrepo/crossrepo.go:174 .function_decl

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-3d31c2a136625c32
- probes: PRB-088
- falsifier: Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing.

## Blast radius

- files: internal/explainers/crossrepo/crossrepo.go, internal/renderers/llmcontext/llm.go
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-074: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing. |
