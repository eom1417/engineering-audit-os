# TASK-089 — 2 symbols share the same structure up to identifier names (internal/extractors/asyncapiextractor/asyncapi.go:27 .method_

> claim: CLM-088 · pattern: canonicalize · priority: 0.0172
...
2 symbols share the same structure up to identifier names (internal/extractors/asyncapiextractor/asyncapi.go:27 .method_

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-87a09d4016bfb0de
- probes: PRB-089
- falsifier: Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing.

## Blast radius

- files: internal/extractors/asyncapiextractor/asyncapi.go, internal/extractors/openapiextractor/openapi.go
