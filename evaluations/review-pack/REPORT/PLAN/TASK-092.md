# TASK-092 — 2 symbols share the same structure up to identifier names (internal/linkers/binders/emberresolver/emberresolver.go:573 .

> claim: CLM-292 · pattern: canonicalize · priority: 0.0172
...
2 symbols share the same structure up to identifier names (internal/linkers/binders/emberresolver/emberresolver.go:573 .

Editing the rule in one copy and not the other makes the paths disagree, and nothing in the code links them.

## Evidence

- facts: FACT-b2b298a8ed852a9b
- probes: PRB-092
- falsifier: Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing.

## Blast radius

- files: internal/linkers/binders/emberresolver/emberresolver.go
...
| Command | Expected |
|---|---|
| human review / مراجعة هندسية | CLM-292: CONFIRMED or REFUTED concerns the observation only; record requirement evidence and decide repair, retain, or blocked_missing_requirement. Evidence that the occurrences encode different rules that evolve for different reasons, which would make a single definition wrong rather than missing. |
